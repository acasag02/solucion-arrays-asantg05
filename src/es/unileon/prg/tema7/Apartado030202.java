...
public class Apartado030202 extends Apartado {
	 ...
	 * tendra como manimo un titular, considerado como titular principal. Al mismo tiempo,
	...
	public void ejercicio05() {
		...
		CuentaBancaria cuenta1 = new CuentaBancaria(1000,new Titular("115458222D","Pedro",35,1000));
		cuenta1.anyadir(new Titular("577225588G","Ana",34,0));
		miBanco.anyadir(cuenta1);

		CuentaBancaria cuenta2 = new CuentaBancaria(0,new Titular("74992586Y","Carlos",18,0));
